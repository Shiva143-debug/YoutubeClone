...
const VideoItemDetails = () => {
  const { id } = useParams();
  const { isDarkTheme, saveVideoButtonClicked } = useContext(ThemeContext);
    ...
    return (
      <PlayerAndVideoDetailsContainer>
        ...
        <DynamicDataContainer>
          ...
          <RightDynamicContainer>
            <AiOutlineLike className={`icon-in-video-item ${likeIconClassName}`} />
            <Button
              active={isLike}
              style={{ color: '#64748b' }}
              onClick={onLikeButtonClicked}
            ...
            <AiOutlineDislike className={`icon-in-video-item ${dislikeIconClassName}`} />
            <Button
              active={isDislike}
              style={{ color: '#2563eb' }}
              onClick={onDislikeButtonClicked}
            ...
            <BiListPlus className={`icon-in-video-item ${saveButtonIconClassName}`} />
            <Button onClick={onSaveButtonClicked} className={saveButtonIconClassName}>
              {saveButtonText}
            </Button>
          </RightDynamicContainer>
        </DynamicDataContainer>
